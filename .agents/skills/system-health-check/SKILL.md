...
4. If anomalies or status desyncs are detected, apply the reconciliation SQL from Section 3G, Section 3H, Section 3I, Section 3P, and Section 3Q of `docs/System Health Checklist.md` and report findings to the user.

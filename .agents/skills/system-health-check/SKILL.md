...
3. Verify the output to ensure:
   ...
   - Broker execution errors in `user_trades` (MT5 error codes 10014 Invalid Volume, 10015 Invalid Price, 10016 Invalid Stops, 10019 Margin) are caught and parent opportunities updated to `REJECTED`.
